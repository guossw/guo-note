...
| 参数大小     | 模型大小 (G) | 场景                   | 机器要求                        | 常见模型                                |
| ------------ | ------------ | ---------------------- | ------------------------------- | --------------------------------------- |
| 0.5~3B       | 0.5 ~ 0.6    | 简单问答               | 集显或任意显卡即可              | Phi-3-mini、Qwen2.5-0.5B、Gemma-2B      |
| 7~8B         | 4~5          | 个人本地聊天、代码辅助 | 8~12GB 显存（RTX 3060 / 4060）  | Llama 3.1 8B、Qwen2.5-7B、Mistral-7B    |
| 13~14B       | 8~9          | 企业任务、长文本分析   | 16GB 显存（RTX 4060 Ti）        | Qwen2.5-14B                             |
| 32~34B       | 19~21        | 高精度专业任务         | 24GB 显存（RTX 4090）           | DeepSeek-33B、Qwen2.5-32B               |
| 70B          | 42~45        | 科研、大型企业         | 32GB+ 或多卡（RTX 5090 / A100） | Llama 3.1 70B、Qwen2.5-72B              |
| 千亿级 / MoE | 200+         | 前沿研究、逼近闭源     | 多卡集群 / 数据中心             | Llama 3 405B、DeepSeek-V3 671B、Kimi K3 |
